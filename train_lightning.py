...
if __name__ == '__main__':
    ...
    checkpoint_callback = ModelCheckpoint(dirpath="checkpoints/" + opt.dataset_name, save_top_k=2, monitor="val_loss")
    # trainer = pl.Trainer(max_epochs=1000, gpus=-1, logger = logger)

    trainer = pl.Trainer(max_epochs=1000, precision=16, gpus = 1, min_epochs=1, auto_lr_find=True, auto_scale_batch_size=False,
